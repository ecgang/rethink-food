      ...
      <Card>
        ...
        <CardBody>
          <div className="mb-2 flex flex-wrap gap-1.5">
            {SAMPLES.map((s) => (
              <button
                ...
                className="rounded-full border border-border px-2.5 py-1 text-xs text-foreground/70 hover:bg-black/[0.04]"
              >
                {s.label}
              </button>
            ))}
          ...
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-border bg-background/40 p-3 text-sm outline-none focus:border-brand"
          />
          <button
            onClick={doParse}
            disabled={isParsing || !raw.trim()}
            className="mt-3 inline-flex items-center gap-2 rounded-lg bg-brand px-4 py-2 text-sm font-medium text-white disabled:opacity-50"
          >
            ...
            <>
              ...
              <div className="mt-4 flex gap-2">
                ...
                <button
                  ...
                  disabled={isDeciding}
                  className="inline-flex items-center gap-1.5 rounded-lg border border-border px-4 py-2 text-sm font-medium disabled:opacity-50"
                >
